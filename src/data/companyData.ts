...
export const companyInfo = {
  ...
  description:
    'شركة مصرية رائدة متخصصة في تطوير وتصنيع أنظمة الطلاء والدهانات الصناعية المتقدمة، وأنظمة الحماية من الحريق، ودهانات NC ذات الأداء العالي للمنشآت والمصانع والهياكل المعدنية والورش المتخصصة.',
  address: '[العنوان: المنطقة الصناعية - جمهورية مصر العربية - قابل للتعديل]',
  phone: '[الهاتف: +20 1X XXXX XXXX - قابل للتعديل]',
  whatsapp: '+201000000000',
  whatsappDisplay: '[واتساب: +20 1X XXXX XXXX]',
  email: 'info@tonavixpaints.com',
  salesEmail: 'sales@tonavixpaints.com',
  workingHours: 'من السبت إلى الخميس: 8:00 صباحاً – 5:00 مساءً',
};
