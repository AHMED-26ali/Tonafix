      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-right max-w-3xl mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-200 leading-relaxed">
            تمت صياغة منتجاتنا لتلائم بيئات التشغيل الثقيلة والمعايير الصارمة في مختلف القطاعات الهندسية والمصانع الإنتاجية والمشروعات بالمملكة العربية السعودية والشرق الأوسط.
          </p>
        </div>
