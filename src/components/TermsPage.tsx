...
export const TermsPage: React.FC<TermsPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-transparent text-slate-200 py-12 sm:py-20 relative overflow-hidden" dir="rtl">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-[#0066ff]/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-[#ec4899]/12 rounded-full blur-[140px] pointer-events-none" />
